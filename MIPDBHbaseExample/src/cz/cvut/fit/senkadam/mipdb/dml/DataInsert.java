 ...
 */
package cz.cvut.fit.senkadam.mipdb.dml;
...
public class DataInsert {
    ...
    public HBaseAdmin getHBaseAdmin() throws ZooKeeperConnectionException, MasterNotRunningException {
     ...
     *
     * @param table instance of Table class that holds information about
     * requested table
